/*! For license information please see 845.66a0e0c8.chunk.js.LICENSE.txt */
(self.webpackChunkreactjs_typescript_boilerplate =
  self.webpackChunkreactjs_typescript_boilerplate || []).push([
  [845],
  {
    1845: function (e, n, t) {
      var o;
      !(function () {
        ...
        r.prototype = {
          ...
          volume: function (e) {
            var n = this || a;
            if (
              ((e = parseFloat(e)), n.ctx || p(), 'undefined' !== typeof e && e >= 0 && e <= 1)
            ) {
          ...
          mute: function (e) {
            ...
            n.ctx || p(),
              (n._muted = e),
              n.usingWebAudio &&
                n.masterGain.gain.setValueAtTime(e ? 0 : n._volume, a.ctx.currentTime);
            for (var t = 0; t < n._howls.length; t++)
              if (!n._howls[t]._webAudio)
                for (var o = n._howls[t]._getSoundIds(), r = 0; r < o.length; r++) {
                  var i = n._howls[t]._soundById(o[r]);
          ...
          _setupCodecs: function () {
            ...
            return (
              (e._codecs = {
                ...
                flac: !!(n.canPlayType('audio/x-flac;') || n.canPlayType('audio/flac;')).replace(
                  /^no$/,
                  '',
                ),
              }),
        ...
        i.prototype = {
          init: function (e) {
            ...
            return (
              ...
              (n._pool = e.pool || 5),
              (n._preload =
                ('boolean' !== typeof e.preload && 'metadata' !== e.preload) || e.preload),
              (n._rate = e.rate || 1),
              (n._sprite = e.sprite || {}),
          ...
          on: function (e, n, t, o) {
            var r = this['_on' + e];
            return (
              'function' === typeof n && r.push(o ? { id: t, fn: n, once: o } : { id: t, fn: n }),
              this
            );
          },
          off: function (e, n, t) {
        ...
        var d = {},
          s = function (e) {
            ...
            if (/^data:[^;]+;base64,/.test(n)) {
              for (
                var t = atob(n.split(',')[1]), o = new Uint8Array(t.length), r = 0;
                r < t.length;
                ++r
              )
                o[r] = t.charCodeAt(r);
              ...
              a.open(e._xhr.method, n, !0),
                ...
                (a.onerror = function () {
                  e._webAudio &&
                    ((e._html5 = !0), (e._webAudio = !1), (e._sounds = []), delete d[n], e.load());
                }),
                _(a);
            }
          },
        ...
        void 0 ===
          ...
          'undefined' !== typeof t.g
            ? ((t.g.HowlerGlobal = r), (t.g.Howler = a), (t.g.Howl = i), (t.g.Sound = u))
            ...
            (Howl.prototype.init =
              ...
              function (n) {
                ...
                return (
                  ...
                  (t._pannerAttr = {
                    coneInnerAngle:
                      'undefined' !== typeof n.coneInnerAngle ? n.coneInnerAngle : 360,
                    coneOuterAngle:
                      'undefined' !== typeof n.coneOuterAngle ? n.coneOuterAngle : 360,
                    coneOuterGain: 'undefined' !== typeof n.coneOuterGain ? n.coneOuterGain : 0,
                    distanceModel:
                      'undefined' !== typeof n.distanceModel ? n.distanceModel : 'inverse',
                  ...
                  d = {
                    ...
                    coneOuterAngle:
                      'undefined' !== typeof e.coneOuterAngle
                        ...
                        : d.coneOuterAngle,
                    coneOuterGain:
                      'undefined' !== typeof e.coneOuterGain ? e.coneOuterGain : d.coneOuterGain,
                    distanceModel:
                      'undefined' !== typeof e.distanceModel ? e.distanceModel : d.distanceModel,
                    maxDistance:
                      'undefined' !== typeof e.maxDistance ? e.maxDistance : d.maxDistance,
                    refDistance:
                      'undefined' !== typeof e.refDistance ? e.refDistance : d.refDistance,
                    rolloffFactor:
                      'undefined' !== typeof e.rolloffFactor ? e.rolloffFactor : d.rolloffFactor,
                    panningModel:
                      'undefined' !== typeof e.panningModel ? e.panningModel : d.panningModel,
                  };
                  var s = o._panner;
                  s
              ...
              return function () {
                ...
                return (
                  ...
                  n._stereo
                    ...
                    : n._panner &&
                      (n._panner.disconnect(0), (n._panner = void 0), t._refreshBuffer(n)),
                  e.call(this)
                );
              };
...
//# sourceMappingURL=845.66a0e0c8.chunk.js.map
