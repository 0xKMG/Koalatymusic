  ...
  <Svg className={className} width="100" height="101.106" viewBox="0 0 64.2 58.18" {...props}>
    <g id="Layer_2-2" data-name="Layer 2">
      <g>
        ...
        <path
          d="M29.72,53.41s.09,.05,.14,.07c-.04-.02-.09-.05-.13-.07,0,0,0,0,0,0Z"
          fill="#ef5aa0"
        />
        <path
          d="M28.92,54.61s.09,.05,.13,.08c-.05-.02-.09-.05-.14-.07,0,0,0,0,0,0Z"
          fill="#ef59a0"
        />
        <path
          d="M35.58,52.29s-.08-.03-.12-.04c.02-.04,.02-.1,.05-.13,.01-.01,.07,.02,.11,.04-.02,.04-.03,.09-.05,.13Z"
          fill="#e982b5"
        />
      </g>
    </g>
...
PinkShell.displayName = 'PinkShell';

export default PinkShell;
